      ...
      <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-12 lg:gap-8 items-center">
        <div className="text-center lg:text-left">
          ...
          <AnimatedBlock delay={0.15}>
            <p className="text-body text-muted-foreground max-w-xl mx-auto lg:mx-0 mb-8">
          ...
          <AnimatedBlock delay={0.2}>
            ...
            <p className="mt-3 text-xs text-muted-foreground/60 flex items-center justify-center lg:justify-start gap-1.5">
        ...
        <AnimatedBlock delay={0.25}>
          <MockupCard
            ...
            chipSide="left"
            className="max-w-[19rem] sm:max-w-sm mx-auto"
            items={[
