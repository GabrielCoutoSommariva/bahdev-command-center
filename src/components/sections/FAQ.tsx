...
const faqs = [
  ...
  { q: "Integra com outros sistemas?", a: "Sim — ERPs, CRMs e ferramentas de comunicação. Na demonstração mapeamos o que faz sentido." },
    ...
    <AnimatedBlock delay={0.15} className="max-w-2xl mx-auto mt-8 text-center">
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
        <Button variant="hero" size="lg" asChild>
          <a href="#demo">Agendar demonstração <ArrowRight className="ml-2 h-4 w-4" /></a>
        </Button>
